# Comparison with Sampling-Based Baselines on MedQA
...
Notes:
- MATU and UProp values are from `sampling_baselines/matu/results/medqa/` and `sampling_baselines/uprop/results/medqa/`.
